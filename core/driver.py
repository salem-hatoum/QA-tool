...
def assistant(assistant_goal="", keep_in_mind="", assistant_identity="", app_name=None, execute_json_case=None, called_from=None):  # App TestCase Gen
    ...
    if not execute_json_case:
        ...
        assistant_goal = imaging(window_title=app_name, additional_context=additional_context, screenshot_size='Full screen')['message']['content']
        ...
        step_analysis = re.sub(r'\\_', '_', step_analysis)
        ...
        execute_json_case = re.sub(r'\\_', '_', execute_json_case)
        ...
        for i, step in enumerate(action_list, start=1):
            ...
            if action == "click_element":
                ...
                while not element_visible and retry_count < max_retries:
                    ...
                    scroll_assistant_goal = check_element_visibility(app_name, step_description)['message']['content']
                ...
                if debug_step is not True:
                    ...
                    if image_analysis:
                        additional_context = (
                            ...
                            f"Focused application: \"{app_name}\".\nGoal: \"{assistant_goal}\".")
                        if new_goal:
                            newest_goal = imaging(window_title=app_name, additional_context=additional_context)  # )['message']['content']
                            # if ": " in newest_goal:
...
def find_element(single_step, app_name, original_goal, avoid_element="", assistant_goal=None, attempt=0):
    ...
    if visioning_match:
        ...
        last_coordinates = imaging_generated_coordinates['message']['content']
    ...
    if rescan_element_match is True:
        ...
        while attempt < max_attempts:
            ...
            if element_analysis_result is None or 'choices' not in element_analysis_result or len(
                    ...
                    element_analysis_result or 'content' not in \
                    element_analysis_result['message']:
                ...
                if attempt >= max_attempts:
                    ...
                    print("Retrying...")
                    pass
            elif 'yes' in element_analysis_result['message']['content'].lower():
